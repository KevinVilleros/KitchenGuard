...
# Kitchen timer
KITCHEN_TIMER_DURATION = 30  # minutes, 0 = off
KITCHEN_TIMER_ALERT_SECONDS = 60  # seconds no person during timer → alert

# Alarm toggles
ALARM_UNATTENDED_ENABLED = True  # primary: unattended cooking
ALARM_SMOKE_ENABLED = True
ALARM_FIRE_ENABLED = True
...
CFG_META = [
    ...
    ("KITCHEN_TIMER_DURATION", "Duración plazo monitoreo (min)", "int", 0, 240, 5),
    ("KITCHEN_TIMER_ALERT_SECONDS", "Alerta sin persona (s)", "int", 10, 300, 5),
]

_CONFIG_KEYS = [m[0] for m in CFG_META] + [
    "CAMERA_ID", "CAMERA_URL", "CAMERA_WIDTH", "CAMERA_HEIGHT", "CAMERA_FPS",
    "YOLO_IMGSZ", "FIRE_AREA_MIN", "SMOKE_AREA_MIN",
    "FIRE_STOVE_ZONE_ONLY", "SMOKE_STOVE_ZONE_ONLY",
    "AUTO_START", "WEB_PORT", "ENABLE_FCM",
    "ALARM_UNATTENDED_ENABLED", "ALARM_SMOKE_ENABLED", "ALARM_FIRE_ENABLED",
]
